...
const Navbar = () => {
  return (
    <div className="border-2 flex items-center justify-between text-white ">
      ...
      <div className="flex gap-8  p-[20px] mx-0!">
        ...
        <div className="flex relative cursor-pointer ">
          ...
          <span className="absolute right-[-10px] top-[-10px] bg-red-500  flex items-center justify-center w-[20px] h-[20px] rounded-full"> 1 </span>
        </div>
